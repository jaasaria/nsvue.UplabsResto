<template>
		<GridLayout marginTop="5" width="100%" row="3" columns="auto,*,auto,auto" rows="auto">
				<GridLayout col="0" rows="auto" columns="auto,auto"  @tap="toggleLike"> 
					<Label col="0" row="0" ref="like" class="like-icon fa" :class="[item.isLike ? 'liked-active' : 'default']"	 :text="item.isLike ? 'fa-thumbs-up':'fa-thumbs-o-up' | fonticon"/>
				...
				<GridLayout col="2" rows="auto" columns="auto,auto"  @tap="toggleHeart" marginRight="15"> 
					<Label col="0" row="0" ref="favorite" class="like-icon  fa" :class="[item.isFavorite ? 'heart-active' : 'default']"	 :text="item.isFavorite ? 'fa-heart':'fa-heart-o' | fonticon"/>
