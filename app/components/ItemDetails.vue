<template>
  <Page
    ...
    statusBarStyle="dark"
    androidStatusBarBackground="#bd2122"
    @loaded="onLoaded"
  >
    <StackLayout class="main" verticalAlignment="top">
      ...
      <ScrollView class="anim-images" orientation="horizontal">
        <StackLayout orientation="horizontal" class>
          <GridLayout for="image in item.images" rows="auto" columns="*">
      ...
      <GridLayout rows="auto,auto,auto,auto" columns="auto" class="content">
        ...
        >
          ...
          <StackLayout row="3" col="1" orientation="horizontal">
            ...
            <Label class="fa rate" :text="'fa-star' | fonticon"/>
            <Label class="fa rate" :text="'fa-star' | fonticon"/>
            <aLbel class="fa rate" :text="'fa-star-half-o' | fonticon"/>
          </StackLayout>
        </GridLayout>
...
export default {
  ...
  methods: {
    ...
    animateLike() {
      ...
      imgLogo
        .animate({ scale: { x: 0.6, y: 0.6 }, duration: 100, delay: 0 })
        .then(function() {
          return imgLogo.animate({ scale: { x: 1.2, y: 1.2, duration: 50 } });
        })
        .then(function() {
          return imgLogo.animate({ scale: { x: 1, y: 1, duration: 100 } });
        })
        .then(function() {});
    },
    animateFavorite() {
      ...
      imgLogo
        .animate({ scale: { x: 0.6, y: 0.6 }, duration: 50, delay: 0 })
        .then(function() {
          return imgLogo.animate({ scale: { x: 1.2, y: 1.2, duration: 50 } });
        })
        .then(function() {
